            ...
            <main className="flex-1">
                ...
                <section className="relative flex min-h-svh items-center">
                    ...
                    {/* Center scrim: mutes the particle field behind the copy so
                        ...
                        On phones it's a tighter horizontal band (pulled-back camera
                        means fewer particles over the copy), so more of the shape
                        stays visible above and below the text. */}
                    <div
                        aria-hidden
                        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_96%_38%_at_50%_50%,var(--background)_42%,transparent_85%)] sm:bg-[radial-gradient(ellipse_55%_45%_at_50%_50%,var(--background)_28%,transparent_72%)]"
                    />
