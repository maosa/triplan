...
export const getWorkoutIcon = (type: string) => {
    switch (type) {
        ...
        case "Bike":
            return <Bike className="h-5 w-5 text-orange-400" />
        case "Run":
            return <div className="h-5 w-5 text-green-400">🏃</div> // Lucide doesn't have a perfect Run icon in all versions, using emoji or fallback
        case "Strength":
