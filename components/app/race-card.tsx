...
import { Calendar, MapPin, Pencil, LayoutGrid, Waves, Bike, Footprints, Dumbbell, BedDouble, Activity } from "lucide-react"
...
export function RaceCard({ race, onEdit, workoutCounts }: RaceCardProps) {
    ...
    // Status badges. The "Race completed" pill aligns with the race-type row;
    // the "days left" pill aligns with the date row.
            ...
            <div className="space-y-5">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {isCompleted ? (!race.race_type && completedBadge) : daysLeftBadge}
                    </div>
